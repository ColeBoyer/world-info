const blocks = [
    ...
    'dried_ghast_hydration_0_tentacles',
    ...
    'dried_ghast_hydration_1_tentacles',
    ...
    'dried_ghast_hydration_2_tentacles',
    ...
    'dried_ghast_hydration_3_tentacles',
...
function check_blocks(value){
    ...
    for(const index in blocks){
        let block_div = document.getElementById(`block_${blocks[index]}`);
        if(blocks[index].includes(value)){
...
function show_drop_down(event){
    const block_container = document.getElementById('block_container');
    block_container.style.display = 'block';
    const block_selector = document.getElementById('_block-selector');
}

function hide_drop_down(event){
    let block_container = document.getElementById('block_container');
    block_container.style.display = 'none';
}

//add listener for typing
document.getElementById('_block-selector').addEventListener('input', (event) => check_blocks(event.target.value));

//add listener for on focus
document.getElementById('_block-selector').addEventListener('focus', (event) => show_drop_down(event));

//add listener for blur
document.getElementById('_block-selector').addEventListener('blur', (event) => hide_drop_down(event));
